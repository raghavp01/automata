...
/* 
  ...
  https://create.arduino.cc/cloud/things/adf77d99-0f1e-4dee-baff-969fba90b863 
...
int switchPin1State = 1;
int switchPin2State = 1;
int switchPin3State = 1;
int switchPin4State = 1;
...
void manual_control() {
  ...
  if (digitalRead(SwitchPin1) != switchPin1State) {
    delay(200);
    relayOnOff(1);
    switchPin1State = digitalRead(SwitchPin1);
  }
  else if (digitalRead(SwitchPin2) != switchPin2State) {
    delay(200);
    relayOnOff(2);
    switchPin2State = digitalRead(SwitchPin2);

  }
  else if (digitalRead(SwitchPin3) != switchPin3State) {
    delay(200);
    relayOnOff(3);
    switchPin3State = digitalRead(SwitchPin3);

  }
  else if (digitalRead(SwitchPin4) != switchPin4State) {
    delay(200);
    relayOnOff(4);
